...
export default function AuditoriaHub({ apiBase }: AuditoriaHubProps) {
    ...
    return (
        <div className="flex-1 flex flex-col min-w-0 bg-[#060a14] overflow-hidden select-none font-sans">
            {/* Barra de Selector Superior */}
            <div className="bg-[#090f1d] border-b border-navy-800 px-6 py-2.5 flex items-center justify-between shrink-0 shadow-md">
                <div className="flex items-center gap-3">
                    <span className="text-[11px] font-black text-slate-400 uppercase tracking-wider">
                        Módulo de Auditoría:
                    </span>
                    <div className="inline-flex p-1 bg-slate-950 rounded-xl border border-navy-900 shadow-inner">
                        ...
                        >
                            ...
                            <span className={`text-[9px] font-black uppercase px-1.5 py-0.5 rounded ${
                                auditMode === 'plt' ? 'bg-slate-950/40 text-slate-900' : 'bg-cyan-500/10 text-cyan-400 border border-cyan-500/20'
                            }`}>
                                QA/QC
                            </span>
                        </button>
