...
export let RELLENO_CATALOG: Record<string, any> = {
  ...
  g: { name: "Panizo (Roca Triturada) (g)", clase: 1, tipo: "Blando", rmr76: 2, rmr89: 2, rmr76_gt5: 0, rmr89_gt5: 0 },
  ...
  sa: { name: "Arena (sa)", clase: 1, tipo: "Blando", rmr76: 2, rmr89: 2, rmr76_gt5: 0, rmr89_gt5: 0 },
};
...
const EQUIVALENCIAS_MIGRACION: Record<string, { lito1: string, lito2: string, lito3: string, k: number }> = {
  ...
  LMT_S4: { lito1: "LMT", lito2: "LMT", lito3: "LMT_S", k: 14.84 },
