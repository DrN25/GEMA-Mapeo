...
export const MANDATORY_FIELD_RULES: MandatoryFieldRules = {
  ...
  pltEnsayos: {
    ...
    // OPCIONALES Y CAMPOS DERIVADOS DE ENSAYO
    ejecutado_por: false,
    muestra: false,
    litologia_2: false,
    litologia_3: false,
    ...
    ancho_w1: false,
    ancho_w2: false,
    muestra_valida_longitud: false,
    muestra_valida_ancho: false,
    direccion_rotura: false,
    tipo_fractura: false,
    diametro_equivalente: false,
    f: false,
    is_mpa: false,
    is_50: false,
    factor_conversion_k: false,
    ucs: false,
    resistencia_isrm: false,
    sector_geotecnico: false,
    zona_mapeo: false,
    observaciones: false
  }
};
